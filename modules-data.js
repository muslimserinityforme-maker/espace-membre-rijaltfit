    ...
    niveaux: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { text: 'Ne te casse plus la tête !' },
          { text: 'Salle ou maison ? Les deux fonctionnent !' },
          ...
          { text: 'Salle = plus de possibilités.<br>Maison = plus de flexibilité.<br>Rijal Fit = les deux selon ta vie.' },
        ],
      },
