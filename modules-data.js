      ...
      },
      {
        ...
        blocks: [
          ...
          { text:
            ...
            '<div class="shop-item"><img src="images/shop-montre-connectee.png" alt="Montre connectée Rijal Fit" loading="lazy"><p class="shop-item__name">Montre connectée Rijal Fit</p><p class="shop-item__status">Non disponible</p><button type="button" class="btn btn--primary" disabled>Acheter</button></div>' +
            '<div class="shop-item"><img src="images/shop-ruban-metre.png" alt="Ruban mètre couture Rijal Fit" loading="lazy"><p class="shop-item__name">Ruban mètre couture Rijal Fit</p><p class="shop-item__status">Non disponible</p><button type="button" class="btn btn--primary" disabled>Acheter</button></div>' +
